				...
				<div class="col-xl-4">
					...
					<a href="#" class="card bg-body-white hoverable card-xl-stretch mb-xl-8">
						...
						<div class="card-body">
							...
							<span class="svg-icon svg-icon-primary svg-icon-3x ms-n1"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
					...
					<div class="card card-xl-stretch mb-5 mb-xl-8">
						...
						<div class="card-header border-0 pt-5">
							...
							<h3 class="card-title align-items-start flex-column">
								<span class="card-label fw-bolder fs-3 mb-1">Sales Chart</span>
								<span class="text-muted fw-bold fs-7">Last one year analysis</span>
							</h3>
							<!--end::Title-->
							<!--begin::Toolbar-->
