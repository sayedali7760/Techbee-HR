<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <?php
                echo form_open_multipart('general_settings/organization/edit_organization', array('id' => 'organization_update', 'role' => 'form','class' => 'form d-flex flex-column flex-lg-row'));
                ?>
                                    ...
                                    <div class="d-flex flex-wrap gap-5">
                                        ...
                                        <div class="fv-row w-100 flex-md-root">
                                            ...
                                            <input type="hidden" id="organization_id" name="organization_id"
                                                value="<?php echo $organization_id; ?>">
                                        ...
                                        <div class="fv-row w-100 flex-md-root">
                                            ...
                                            <input type="text" class="form-control mb-5" id="mail" name="mail"
                                                placeholder="Mail-Id" maxlength="50" value="<?php echo $mail_id; ?>">
                                        </div>
                                        <div class="fv-row w-100 flex-md-root">
...
function update_data() {
    var ops_url = baseurl + 'organization/update-organization';
        ...
        success: function(result) {
            ...
            if (data.status == 0) {
                Swal.fire({
                    icon: 'warning',
                    title: 'Warning',
                    text: 'Distributor already exist.'
                }).then((result) => {
                    if (result.isConfirmed) {
                        location.reload();
                    }
