                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_report_sales_table">
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="text-strat min-w-75px">Distributor</th>
                                <th class="text-start min-w-75px">Mail-Id</th>
                                <th class="text-start min-w-75px">Mobile</th>
                        ...
                        <tbody class="fw-bold text-gray-600">
                            ...
                            <tr>
                                ...
                                <td class="text-start pe-0"><?php echo $data->mail_id; ?></td>
                                <td class="text-start pe-0"><?php echo $data->mobile; ?></td>
                                <td class="text-start pe-0"><?php echo date('d/m/Y', strtotime($data->created_on)); ?></td>
                                <td class="text-start pe-0">
                                    ...
                                    <div class="form-check form-switch form-check-custom form-check-solid me-10">
                                        <input class="form-check-input h-30px w-50px" type="checkbox"
                                            ...
                                            onchange="change_status('<?php echo $data->organization_id; ?>', '<?php echo $data->is_active; ?>')" />
                                    </div>
                                </td>
                                <td>
                                    <a href="javascript:void(0);"
                                        class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1"
                                        onclick="edit_organization('<?php echo $data->organization_id; ?>','<?php echo $data->name; ?>','<?php echo $data->mail_id; ?>','<?php echo $data->mobile; ?>')">
