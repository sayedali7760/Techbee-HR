    ...
    <div class="card card-flush py-4 flex-row-fluid">
        ...
        <div class="card-header">
            <div class="card-title">
                <h2>Task Details - <?php echo $task_details_single->title; ?></h2>
            </div>
        </div>
        <!--end::Card header-->
        <!--begin::Card body-->
                ...
                <table class="table align-middle table-row-bordered mb-0 fs-6 gy-5">
                    ...
                    <tbody class="fw-bold text-gray-600">
                        ...
                        <tr>
                            ...
                            <td class="fw-bolder text-end"><?php echo $task_details_single->title; ?></td>
                        </tr>
                        <!--end::IP address-->
                        <!--begin::Forwarded IP-->
                        <tr>
                            <td class="text-muted">Due Date</td>
                            <td class="fw-bolder text-end"><?php echo date('d/m/Y', strtotime($task_details_single->due_date)); ?></td>
                        </tr>
                        <!--end::Forwarded IP-->
                        <!--begin::User agent-->
                        <tr>
                            <td class="text-muted">Description</td>
                            <td class="fw-bolder text-end"><?php echo $task_details_single->description; ?></td>
                        </tr>
                        <!--end::User agent-->
                        <!--begin::Accept language-->
                        <tr>
                            <td class="text-muted">File</td>
                            <td class="fw-bolder text-end"><a title="Download" target="_blank" href="<?php echo base_url() ?>uploads/<?php echo $task_details_single->file; ?>" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                        ...
                        <tr>
                            ...
                            <td class="fw-bolder text-end"><?php echo date('d/m/Y', strtotime($task_details_single->created_on)); ?></td>
                        </tr>
                        <tr>
                            <td class="text-muted">Status</td>
                            <td class="fw-bolder text-end"><?php
                                                            if ($task_details_single->status == 0) {
                                                                echo '<span class="badge badge-warning">Pending</span>';
                                                            } else if ($task_details_single->status == 1) {
