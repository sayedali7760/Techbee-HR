                        ...
                        <tbody class="fw-bold text-gray-600">
                            ...
                            foreach ($task_details as $task) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                        if ($task->status == 0) { ?><a title="Complete" href="javascript:void(0);" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" onclick="change_task_status(<?php echo $task->id; ?>)">
                                        ...
                                        <?php } ?>
                                        <a title="View" href="javascript:void(0);" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" onclick="view_task(<?php echo $task->id; ?>)">
