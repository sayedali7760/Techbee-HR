                            ...
                            <table cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td class="content-block">
                                        ...
                                        Dear Staff,
                                        <br /><br />
                                        We have received a new client bank account associated with Client ID: <?php echo $id; ?> that requires verification.
                                        Kindly review the details and proceed with the necessary verification steps at your earliest convenience.<br />

                                        Please ensure all required documentation and compliance checks are completed promptly.<br />
