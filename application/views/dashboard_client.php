				...
				<div class="row g-5 g-xl-8">
					<div class="col-xl-4">
						<div class="row mb-5 mb-xl-8 g-5 g-xl-8">
							<div class="col-6">
								<div class="card card-stretch">
									<a href="<?php echo base_url(); ?>task/assigned-tasks" id="live_button_a" class="btn btn-flex btn-text-gray-800 btn-icon-primary btn-active-color-primary bg-body flex-column justfiy-content-start align-items-start text-start w-100 p-10">
										...
										<span class="fs-4 fw-bolder">Tasks
										</span>
									</a>
								</div>
							</div>
							<div class="col-6">
								<div class="card card-stretch">
									<a href="<?php echo base_url(); ?>client/refund" id="demo_button_a" class="btn btn-flex btn-text-gray-800 btn-icon-gray-400 btn-active-color-primary bg-body flex-column justfiy-content-start align-items-start text-start w-100 p-10">
										<span class="svg-icon svg-icon-3x mb-5">
											<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
										...
										<span class="fs-4 fw-bolder">Refund</span>
									</a>
								</div>
							</div>
							<div class="col-6">
							...
							<div class="col-6">
								<div class="card card-stretch">
									<a href="<?php echo base_url(); ?>client/client-salary-history" class="btn btn-flex btn-text-gray-800 btn-icon-gray-400 btn-active-color-primary bg-body flex-column justfiy-content-start align-items-start text-start w-100 p-10">
										<span class="svg-icon svg-icon-3x mb-5">
											<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
					...
					<div class="col-xl-8 ps-xl-12">
						<div id="create_mtl_div" class="card bgi-position-y-bottom bgi-position-x-end bgi-no-repeat bgi-size-cover min-h-250px mb-5 mb-xl-8" style="background-color: #1f2446;background-position: 100% 50px;background-size: 500px auto;background-image:url('assets/media/misc/city.png')">
