    ...
    <div class="hover-scroll-overlay-y px-2 my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
        ...
        <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
            ...
            ?>
                ...
                <?php } ?>
                <div data-kt-menu-trigger="click"
                    class="menu-item menu-accordion <?php if ($title == 'Staff') {
                                                        echo "hover show";
                                                    } ?>">
                    <span class="menu-link">
                        <span class="menu-icon">
                    ...
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        <div class="menu-item">
                            <a class="menu-link <?php if ($subtitle == 'Add Staff') {
                                                    echo "active";
                                                } ?>"
                        ...
                        <div class="menu-item">
                            <a class="menu-link <?php if ($subtitle == 'Staff List') {
                                                    echo "active";
                                                } ?>"
                ...
                <div data-kt-menu-trigger="click"
                    class="menu-item menu-accordion <?php if ($title == 'Payroll') {
                                                        echo "hover show";
                                                    } ?>">
                    <span class="menu-link">
                        <span class="menu-icon">
                    ...
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        ...
                        <div class="menu-item">
                            <a class="menu-link <?php if ($subtitle == 'Refund Request') {
                                                    echo "active";
                                                } ?>"
                                href="<?php echo base_url(); ?>admin/refund">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                    ...
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        ...
                        <div class="menu-item">
                            <a class="menu-link <?php if ($subtitle == 'Payroll Payment') {
                                                    echo "active";
                                                } ?>"
                                href="<?php echo base_url(); ?>client/payroll">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                                <span class="menu-title">Payroll Payment</span>
                            </a>
                        </div>
                    ...
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        ...
                        <div class="menu-item">
                            <a class="menu-link <?php if ($subtitle == 'Payroll Details') {
                                                    echo "active";
                                                } ?>"
                                href="<?php echo base_url(); ?>client/payroll-added">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                                <span class="menu-title">Payroll Details</span>
                            </a>
                        </div>
                ...
                <div data-kt-menu-trigger="click"
                    class="menu-item menu-accordion <?php if ($title == 'Task') {
                                                        echo "hover show";
                                                    } ?>">
                    <span class="menu-link">
                        <span class="menu-icon">
                    ...
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        ...
                        <div class="menu-item">
                            <a class="menu-link <?php if ($subtitle == 'Schedule Task') {
                                                    echo "active";
                                                } ?>"
                                href="<?php echo base_url(); ?>task/scheule-task">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                    ...
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        ...
                        <div class="menu-item">
                            <a class="menu-link <?php if ($subtitle == 'Scheduled Tasks') {
                                                    echo "active";
                                                } ?>"
                                href="<?php echo base_url(); ?>task/scheuled-tasks">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                ...
                <div data-kt-menu-trigger="click"
                    class="menu-item menu-accordion <?php if ($title == 'Leave') {
                                                        echo "hover show";
                                                    } ?>">
                    <span class="menu-link">
                        <span class="menu-icon">
                    ...
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        ...
                        <div class="menu-item">
                            <a class="menu-link <?php if ($subtitle == 'Leave Applied') {
                                                    echo "active";
                                                } ?>"
                                href="<?php echo base_url(); ?>leave/applied-leave-admin">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                                <span class="menu-title">Leave Applied</span>
                            </a>
                        </div>
            ...
            <?php } else { ?>
                ...
                <div data-kt-menu-trigger="click"
                    ...
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        <div class="menu-item">
                            <a class="menu-link <?php if ($subtitle == 'Refund') {
                                                    echo "active";
                                                } ?>"
                                href="<?php echo base_url(); ?>client/refund">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                        ...
                        <div class="menu-item">
                            <a class="menu-link <?php if ($subtitle == 'Applied Refund') {
                                                    echo "active";
                                                } ?>"
                                href="<?php echo base_url(); ?>client/applied-refund">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                                <span class="menu-title">Applied for Refund</span>
                            </a>
                        </div>
                        <div class="menu-item">
                            <a class="menu-link <?php if ($subtitle == 'Salary History') {
                                                    echo "active";
                                                } ?>"
                                href="<?php echo base_url(); ?>client/client-salary-history">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                ...
                <div data-kt-menu-trigger="click"
                    ...
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        ...
                        <div class="menu-item">
                            <a class="menu-link <?php if ($subtitle == 'Assigned Tasks') {
                                                    echo "active";
                                                } ?>"
                                href="<?php echo base_url(); ?>task/assigned-tasks">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                ...
                <div data-kt-menu-trigger="click"
                    ...
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        ...
                        <div class="menu-item">
                            <a class="menu-link <?php if ($subtitle == 'Apply Leave') {
                                                    echo "active";
                                                } ?>"
                                href="<?php echo base_url(); ?>leave/apply-leave">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                    ...
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        ...
                        <div class="menu-item">
                            <a class="menu-link <?php if ($subtitle == 'Applied Leave') {
                                                    echo "active";
                                                } ?>"
                                href="<?php echo base_url(); ?>leave/applied-leave">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                                <span class="menu-title">Applied Leave</span>
                            </a>
                        </div>
